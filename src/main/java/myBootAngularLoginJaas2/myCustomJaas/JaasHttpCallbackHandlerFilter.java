...
public class JaasHttpCallbackHandlerFilter extends GenericFilterBean {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JaasHttpCallbackHandlerFilter.class);
